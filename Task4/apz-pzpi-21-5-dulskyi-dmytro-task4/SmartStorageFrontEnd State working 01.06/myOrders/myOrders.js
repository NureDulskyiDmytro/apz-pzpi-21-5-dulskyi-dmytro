...
function renderUserProducts(arr) {
    arr.forEach(element => {
        ...
        productContainer.appendChild(mainDiv);
            ...
            humidityRangeNow.innerHTML = `Humidity Range Now: <br><span class="sub-text">${element[2]}</span>`;
            mainDiv.appendChild(humidityRangeNow);

            let humidityRange = document.createElement('h5');
            humidityRange.innerHTML = `Humidity Range: <br><span class="sub-text">${element[3]}</span>`;
            ...
            size.innerHTML = `SIZE: <br><span class="sub-text">${element[5]}</span>`;
            ...
            storageLife.innerHTML = `Storage Life: <br><span class="sub-text">${element[7]}</span>`;
            mainDiv.appendChild(storageLife);

            let summa = document.createElement('h5');
            summa.innerHTML = `Summa: <br><span class="sub-text">${element[8]}$</span>`;
            ...
            temperatureRange.innerHTML = `Temperature Range: <br><span class="sub-text">${element[10]}</span>`;
            mainDiv.appendChild(temperatureRange);

            let typeOfProduct = document.createElement('h5');
            typeOfProduct.innerHTML = `Type Of Product: <br><span class="sub-text">${element[11]}</span>`;
            mainDiv.appendChild(typeOfProduct);

            let weight = document.createElement('h5');
            weight.innerHTML = `Weight: <br><span class="sub-text">${element[12]}</span>`;
